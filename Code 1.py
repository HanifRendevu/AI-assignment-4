...
#base_path = To do
files = {
    "Bridge": "Data(1)converted_coordinates_Resultat_Bridge.csv",
    "RailJoint": "Data(1)converted_coordinates_Resultat_RailJoint.csv",
    "Turnout": "Data(1)converted_coordinates_Turnout.csv"
}
#############################################################
